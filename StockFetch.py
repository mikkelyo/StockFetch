...
class Stocks:
    ...
    def get_dataframe(self,strat1=False):
...
if __name__ == '__main__':
    ...
    x = Stocks()
#    x.symbol_init('DIS AAPL maersk-b.co INTC L RL CCL FOXA HST LYV')
